...
const ICON = {
  ...
  rounds: "https://www.figma.com/api/mcp/asset/ef54afcd-ab76-43bd-8bc1-931ccacea8ed",
  clock: "https://www.figma.com/api/mcp/asset/05e634c2-0636-4300-8e25-881b1fa20e7d",
  lateQualification: "https://www.figma.com/api/mcp/asset/a92e88b2-022a-4510-a482-ac692052d9ca",
  coins: "https://www.figma.com/api/mcp/asset/4c2b839d-82e9-4d25-9ba4-67a480ad46f5",
  members: "https://www.figma.com/api/mcp/asset/ae1fc029-a77a-4808-b62d-2f4934f9f233",
  infoCircle: "https://www.figma.com/api/mcp/asset/674902cd-a58f-4ae7-b72f-54438b5ed388",
};

const PROVIDER_LOGO: Record<string, { src: string; inset: string }> = {
  hacksaw:  { src: "https://www.figma.com/api/mcp/asset/c1e5330f-1fcc-4027-95e4-d340b0a47bd2", inset: "6.25% 14.69% 6.25% 18.75%" },
  slingo:   { src: "https://www.figma.com/api/mcp/asset/0acddbe2-d46a-42e8-a637-047bf482d183", inset: "25% 0 26.29% 0" },
  pragmatic:{ src: "https://www.figma.com/api/mcp/asset/d7a15624-fec7-4f05-b8d7-4b45ee26524c", inset: "0 13.73% 0 16.11%" },
  playngo:  { src: "https://www.figma.com/api/mcp/asset/e4d2c52e-8948-4698-899d-0024bc529fa7", inset: "23.2% 0 0 6.25%" },
  quickspin:{ src: "https://www.figma.com/api/mcp/asset/43fa71fd-8a3c-4cfd-8169-fd179e265ead", inset: "12.5% 12.5% 9.14% 6.25%" },
};

const GAME_IMAGES = [
  "https://www.figma.com/api/mcp/asset/286ce611-cb92-4bc3-bdb3-dbd32fe4cc5c",
  "https://www.figma.com/api/mcp/asset/9bcb2bcd-ff0c-4dbc-9774-c8a5cdd8edfa",
  "https://www.figma.com/api/mcp/asset/e915a3e7-7ca6-42c4-8c32-2c92deb54ff5",
  "https://www.figma.com/api/mcp/asset/811c403e-5fff-4c09-9ec5-ecffe4632df7",
  "https://www.figma.com/api/mcp/asset/62796214-fc41-41b3-81a5-69d2c52721ca",
  "https://www.figma.com/api/mcp/asset/8fc3900c-afbb-4517-be75-8a5f958df141",
  "https://www.figma.com/api/mcp/asset/0954bbcf-a364-49d4-8ff9-dcce8328f956",
  "https://www.figma.com/api/mcp/asset/9b231885-3e67-4229-8d17-c08ef7155394",
  "https://www.figma.com/api/mcp/asset/43fe6102-64b7-49c3-97ff-169dc95d4943",
  "https://www.figma.com/api/mcp/asset/e6ce6679-aaf0-4f6e-834f-c3f8d3e9e5bb",
];
...
const TABLE_LEFT: ParticipantEntry[] = [
  { rank: 1, name: "@hhhhhhhhh", subtitle: "active 6 hours ago", status: "qualified", type: "muted" },
  { rank: 0, name: "-", status: "qualified", type: "empty" },
  { rank: 18, name: "@trusta", subtitle: "playing Rich Wilde Tome of Mad...", status: "qualified", type: "normal" },
  { rank: 19, name: "@kai", status: "not qualified", type: "yours" },
  { rank: 20, name: "@hidden", subtitle: "active 6 hours ago", status: "not qualified", type: "muted" },
  { rank: 0, name: "-", status: "not qualified", type: "empty" },
  { rank: 150, name: "@texnologes", subtitle: "playing Rich Wilde Tome of Mad...", status: "not qualified", type: "normal" },
];

const TABLE_RIGHT: ParticipantEntry[] = [
  { rank: 1, name: "@hhhhhhhhh", subtitle: "active 6 hours ago", status: "qualified", type: "muted" },
  { rank: 2, name: "@solarsamurai", subtitle: "playing Rich Wilde Tome of Mad...", status: "qualified", type: "normal" },
  { rank: 3, name: "@steelserpent", subtitle: "active 2 hours ago", status: "not qualified", type: "muted" },
  { rank: 4, name: "@cyberphoenix", subtitle: "playing Rich Wilde Tome of Mad...", status: "qualified", type: "normal" },
  { rank: 5, name: "@hidden", subtitle: "playing Rich Wilde Tome of Mad...", status: "not qualified", type: "muted" },
  { rank: 6, name: "@neonexplode...", subtitle: "active 4 hours ago", status: "not qualified", type: "muted" },
];
...
const GAMES_ROW1: GameCard[] = [
  { id: "g1", image: GAME_IMAGES[0], provider: "pragmatic" },
  { id: "g2", image: GAME_IMAGES[1], badge: "Exclusive", provider: "playngo" },
  { id: "g3", image: GAME_IMAGES[2], provider: "slingo" },
  { id: "g4", image: GAME_IMAGES[3], badge: "New", provider: "playngo" },
  { id: "g5", image: GAME_IMAGES[4], provider: "pragmatic" },
];

const GAMES_ROW2: GameCard[] = [
  { id: "g6", image: GAME_IMAGES[5], provider: "playngo" },
  { id: "g7", image: GAME_IMAGES[6], provider: "pragmatic" },
  { id: "g8", image: GAME_IMAGES[7], badge: "New", provider: "hacksaw" },
  { id: "g9", image: GAME_IMAGES[8], provider: "playngo" },
  { id: "g10", image: GAME_IMAGES[9], provider: "quickspin" },
];
  ...
  return (
    <svg width="30" height="30" viewBox="0 0 30 30" fill="none">
      <path
        ...
        fill="url(#contest_logo_grad)"
      />
      <defs>
        <linearGradient id="contest_logo_grad" x1="4.72155" y1="-8.21918" x2="24.0194" y2="27.8503" gradientUnits="userSpaceOnUse">
...
function ArrowRightSmallIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path d="M6 3L11 8L6 13" stroke="#ebebf2" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
    ...
    >
      <div className="flex flex-col gap-2 items-start w-full">
        ...
        <div className="flex items-center p-3 rounded-[8px] w-full" style={{ backgroundColor: "#363555" }}>
          <p className="font-bold text-[20px] text-primary-600 leading-[23px] whitespace-nowrap">10x iPhone 11 Pro 256GB</p>
        </div>
      </div>
...
function QualificationSection() {
  return (
    <div
      className="flex flex-col gap-4 items-start overflow-clip rounded-[16px] w-full"
      style={{ backgroundColor: "#2E2D49", boxShadow: "0px 1px 5px 2px rgba(0,0,0,0.15)" }}
    >
      <div className="flex flex-col gap-2 items-start p-3 w-full">
        <p className="text-lg text-primary-600 leading-[16px]">Qualification</p>

        <div className="relative w-full h-2 rounded-[8px]" style={{ backgroundColor: "#363555" }}>
          <div
            className="absolute top-0 left-0 h-full rounded-[8px] pr-[180px]"
            style={{ backgroundColor: "#8352FF", width: "40%" }}
          />
        </div>
        ...
        <div className="flex items-center justify-between w-full mt-1">
          <div className="flex flex-col items-start">
            <div
              ...
              style={{ borderLeft: "4px solid transparent", borderRight: "4px solid transparent", borderBottom: "4px solid #8352FF" }}
            />
            <div className="flex items-center justify-center px-2 py-1 rounded-[8px]" style={{ backgroundColor: "#8352FF" }}>
              <span className="font-bold text-lg text-white leading-[16px]">&euro;234</span>
            </div>
          </div>
          <div className="flex flex-col items-end">
            <div
              className="w-0 h-0 mr-2"
              style={{ borderLeft: "4px solid transparent", borderRight: "4px solid transparent", borderBottom: "4px solid #363555" }}
            />
            <div className="flex items-center justify-center px-2 py-1 rounded-[8px]" style={{ backgroundColor: "#363555" }}>
              <span className="font-bold text-lg leading-[16px]" style={{ color: "#B5B5C5" }}>&euro;500</span>
            </div>
          </div>
        </div>
      </div>
...
function StatusRow() {
  return (
    <div
      className="flex gap-2 items-center overflow-clip rounded-[16px] p-3 w-full"
      style={{ backgroundColor: "#2E2D49", boxShadow: "0px 1px 5px 2px rgba(0,0,0,0.15)" }}
    >
      <ConditionIcon src={ICON.information} inset="inset-[6.26%_30.19%]" clip />
      <p className="text-lg leading-[16px]">
        <span style={{ color: "#B5B5C5" }}>Your status: </span>
        <span className="font-bold" style={{ color: "#EBEBF2" }}>not qualified</span>
      </p>
    </div>
  );
}
...
function ConditionsBlock() {
  const rows: { src: string; inset: string; clip?: boolean; content: React.ReactNode }[] = [
    {
      src: ICON.rounds,
      inset: "inset-[8.33%]",
      content: <span className="text-lg leading-[16px]" style={{ color: "#B5B5C5" }}>Maximum rounds: 10</span>,
    },
    {
      src: ICON.clock,
      inset: "inset-[8.33%]",
      content: <span className="text-lg leading-[16px]" style={{ color: "#B5B5C5" }}>Round duration: 4 days</span>,
    },
    {
      src: ICON.lateQualification,
      inset: "inset-0",
      content: (
        <span className="text-lg leading-[16px]">
          <span style={{ color: "#B5B5C5" }}>Late qualification: </span>
          <span className="font-bold" style={{ color: "#EBEBF2" }}>available</span>
        </span>
      ),
    },
    {
      src: ICON.coins,
      inset: "inset-[18.55%_3.94%_18.56%_3.95%]",
      clip: true,
      content: <span className="text-lg leading-[16px]" style={{ color: "#B5B5C5" }}>Bets to qualify in round #10: &euro;500</span>,
    },
    {
      src: ICON.members,
      inset: "inset-[8.33%_8.33%_8.33%_8.17%]",
      content: <span className="text-lg leading-[16px]" style={{ color: "#B5B5C5" }}>Players qualified: 143</span>,
    },
  ];
  ...
  return (
    ...
    >
      {rows.map((row, i) => (
        <div key={i} className="flex gap-2 items-center p-3 w-full" style={{ backgroundColor: "#2E2D49" }}>
          <div className={`relative shrink-0 w-5 h-5 overflow-clip`}>
            <div className={`absolute ${row.inset}`}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img alt="" className="absolute block max-w-none w-full h-full" src={row.src} />
            </div>
          </div>
          <p className="flex-1">{row.content}</p>
        </div>
      ))}
    </div>
  );
    ...
    >
      ...
      >
        <div className="flex flex-1 flex-col justify-center min-h-px min-w-px">
          <p className="font-bold text-[16px] text-primary-600 leading-[18px] text-left">Contest Rules</p>
        </div>
        <motion.div
          className="shrink-0"
        ...
        {open && (
          ...
          >
            ...
            <div className="text-[14px] text-primary-600 leading-[20px] w-full">
              <p className="mb-5">
                Welcome to the contest! The contest name is Loyal to NetEnt which kind of explains everything - the most persistent, loyal and luckiest will share the contest prizes. This contest is all about games of the contest displayed on the left on this page. The contest will define 10 finalists and each of them will receive a brand new iPhone 11 Pro 256 Gb as winner&apos;s prize. The contest is not limited by time, it will end only when the winners are selected in the final round. A round in which 10 or less players have qualified is the semi final round. Only players who have qualified in the semi final round can participate in the final round. That easy! So, to take part in the contest a player needs to sequentially qualify in starting round and every next round. To become a winner a player needs to qualify in final round. However you still can take part in the contest even if you missed starting round or even several rounds - you just need to qualify in any current round if it is marked with &ldquo;late qualification available&rdquo;. Do not postpone your participation though, late qualification becomes unavailable the closer number of participants reaches number of finalists (usually when number of qualified players in a round is not more than twice as many as number of winners). Current round qualification basically means certain amount of bets that a player has to wager in contest game during the round period.
              </p>
              <p className="mb-5">
                This sum is shown in the information about contest. Amount of bets a player needs to place in any next round can be different from such amount in any previous round. In order to make sure you have qualified in current round and have advanced to next round please check the table below. This contest and its prize is a subject to terms and conditions. Our casino reserves the right to review transaction records and logs from time to time, for any reason whatsoever. If, upon such a review, it appears that player is participating in strategies that our casino in its sole discretion deems to be abusive, we reserve the right to revoke the entitlement of such a player to the promotion. If upon such review, the players&apos; practices have been deemed to be &ldquo;Promotion Abuse&rdquo;, we have the right to take the following actions, at its sole discretion, against such abusers: We reserve the right to revoke and/or cancel any bonuses and winnings that We regard may have been redeemed by misuse of the system. Abusing player accounts may be terminated immediately. Players found to be abusing Bonus offers may be barred from receiving further Bonuses. We reserve the right to change the terms and conditions of any Bonus promotional offer at any time and it is the responsibility of the player to periodically check for changes and updates.
              </p>
              <p>
                <span>See </span>
...
function ParticipantsSection() {
  return (
    <div className="flex flex-col gap-4 items-start w-full">
      <p className="font-bold text-[16px] text-primary-600 leading-[18px] w-full">Participants</p>

      <div className="-mx-4 w-[calc(100%+32px)]">
        <div className="flex gap-2 items-start overflow-x-auto scrollbar-hide px-4">
          <ParticipantTable entries={TABLE_LEFT} />
          <ParticipantTable entries={TABLE_RIGHT} />
        </div>
      </div>
    </div>
  );
...
function ParticipantTable({ entries }: { entries: ParticipantEntry[] }) {
  return (
    <div
...
function ContestGamesSection() {
  return (
    <div className="flex flex-col gap-4 items-start w-full">
      <div className="flex items-center justify-between w-full">
        <p className="flex-1 font-bold text-[16px] text-primary-600 leading-[18px]">Contest Games</p>
...
function GameCardItem({ game }: { game: GameCard }) {
  return (
    ...
    >
      ...
      {game.badge && (
        <div
          className="absolute left-1/2 -translate-x-1/2 top-1 flex items-center justify-center px-2 py-1 rounded-[16px]"
          style={{ backgroundColor: "rgba(0,0,0,0.6)" }}
        >
          <span className="font-bold text-[10px] text-white leading-[11px] whitespace-nowrap">
            {game.badge}
          </span>
        </div>
      )}

      <div className="absolute bottom-0 left-0 right-0 h-8 flex items-center justify-between p-2">
        <div className="relative shrink-0 w-4 h-full">
          {PROVIDER_LOGO[game.provider] && (
            <div className="absolute" style={{ inset: PROVIDER_LOGO[game.provider].inset }}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img alt="" className="absolute block max-w-none w-full h-full" src={PROVIDER_LOGO[game.provider].src} />
            </div>
          )}
        </div>
        <div className="relative shrink-0 size-4">
          <div className="absolute flex inset-[8.33%] items-center justify-center">
            <div className="-scale-y-100 flex-none size-5">
              <div className="relative size-full">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img alt="" className="absolute block max-w-none w-full h-full" src={ICON.infoCircle} />
              </div>
            </div>
          </div>
        </div>
...
function ContestFooter() {
  return (
    ...
    >
      ...
      <p className="text-lg text-primary-400 leading-[20px] w-full">
        &copy; 2024 Your Casino. All rights reserved. Licensed and regulated by [Licensing Authority], License
        Number [000000].
      </p>
    </div>
  );
