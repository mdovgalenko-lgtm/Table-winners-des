...
/* ═══ Figma Asset URLs (expire in 7 days – replace with permanent URLs) ═══ */

const BANNER_IMG =
  "https://www.figma.com/api/mcp/asset/5ec3dd2f-ed83-4bc1-8d69-d996e1efef1a";

const ICON = {
  information: "https://www.figma.com/api/mcp/asset/79f10aa8-d195-4290-8f6e-0141c501f1f2",
  present: "https://www.figma.com/api/mcp/asset/27090cd8-40df-4a9a-800c-f92516fbe929",
  coins: "https://www.figma.com/api/mcp/asset/0665d9bc-3c35-4597-a029-2b9dfe20a0fd",
  members: "https://www.figma.com/api/mcp/asset/60382318-a49f-4ddb-b0eb-c8566c47c14d",
  moneyBag: "https://www.figma.com/api/mcp/asset/61380073-e0f3-49d2-bb35-7f69e900f3ea",
  winner: "https://www.figma.com/api/mcp/asset/43398c8e-de93-4952-af28-dc1b4b77dee1",
  multiplication: "https://www.figma.com/api/mcp/asset/c5a7f5ec-e91a-4673-b0ca-60e5fe43f36f",
  fire: "https://www.figma.com/api/mcp/asset/94d38619-a797-4f80-a87c-404eda8530cb",
  infoCircle: "https://www.figma.com/api/mcp/asset/676778f0-c39b-4db7-9683-2e3ed80773ad",
};
...
const GAME_IMAGES = [
  "https://www.figma.com/api/mcp/asset/924d66d6-f29d-4db6-a620-e8e76b9de768",
  "https://www.figma.com/api/mcp/asset/a724fae3-72c4-4c4d-a2d4-50f86a28436a",
  "https://www.figma.com/api/mcp/asset/1924bfdc-eca7-4135-8fdd-27dcd33fd9a0",
  "https://www.figma.com/api/mcp/asset/a076f41c-d29b-44e5-8f38-0164a74ce0bf",
  "https://www.figma.com/api/mcp/asset/1a3a3c80-1db8-4ded-8d1e-2a51e3f26ba7",
  "https://www.figma.com/api/mcp/asset/8939c625-c3b4-41a9-ac0f-33eadeaba8e5",
  "https://www.figma.com/api/mcp/asset/52f47ed3-a19b-4a58-aa36-928a1b996711",
  "https://www.figma.com/api/mcp/asset/fc6c316a-8497-46da-8aca-251e75944500",
  "https://www.figma.com/api/mcp/asset/ee4b80d7-e127-4e87-8ca0-0f954c7873e9",
  "https://www.figma.com/api/mcp/asset/3bd8bd1f-63f4-47f9-b45e-5d77f5374fa6",
];
...
const LEADERBOARD_TABS = ["Main", "Win Streak", "Win Multiplier", "Total Bet", "Total Win"];
...
const TABLE_RIGHT: LBEntry[] = [
  { rank: 1, name: "@hhhhhhhhh", subtitle: "active 6 hours ago", score: "10388", prize: "€798.87", type: "muted" },
  { rank: 2, name: "@solarsamurai", subtitle: "playing Rich Wilde Tome of Mad...", score: "94736", prize: "€765.77", type: "normal" },
  { rank: 3, name: "@steelserpent", subtitle: "active 2 hours ago", score: "91836", prize: "€678.34", type: "muted" },
  { rank: 4, name: "@cyberphoenix", subtitle: "playing Rich Wilde Tome of Mad...", score: "90827", prize: "€643.08", type: "normal" },
  { rank: 5, name: "@hidden", subtitle: "playing Rich Wilde Tome of Mad...", score: "89372", prize: "€568.34", type: "normal" },
  { rank: 6, name: "@neonnebula", subtitle: "active 4 hours ago", score: "74292", prize: "€523.87", type: "muted" },
];
...
const CONDITIONS_1: ConditionItem[] = [
  { src: ICON.present, inset: "inset-[8.33%_11.7%_8.33%_12.5%]", text: "Your current prize: €100" },
  { src: ICON.coins, inset: "inset-[18.55%_3.94%_18.56%_3.95%]", clip: true, text: "Minimal bet: €0.5" },
  { src: ICON.members, inset: "inset-[8.33%_8.33%_8.33%_8.17%]", text: "Players: 189" },
];

const CONDITIONS_2: ConditionItem[] = [
  { src: ICON.moneyBag, inset: "inset-[6.25%_7.69%_6.25%_7.7%]", clip: true, text: "Sum of bets - earn points based on the total amount of bets you place." },
  { src: ICON.winner, inset: "inset-[4.17%]", clip: true, text: "Sum of wins - earn points based on your total winnings." },
  { src: ICON.multiplication, inset: "inset-[4.17%]", clip: true, text: "Bet multiplier - earn points when you win with a multiplier on your bet." },
  { src: ICON.fire, inset: "inset-[9.52%_13.89%_7.15%_16.67%]", clip: true, text: "Win streak - earn points for winning multiple times in a row." },
];

/* ═══ Header Icons (same inline SVGs as PromotionsContent) ═══ */
  ...
  return (
    <svg width="30" height="30" viewBox="0 0 30 30" fill="none">
      <path
        ...
        fill="url(#tour_logo_grad)"
      />
      <defs>
        <linearGradient id="tour_logo_grad" x1="4.72155" y1="-8.21918" x2="24.0194" y2="27.8503" gradientUnits="userSpaceOnUse">
...
function TournamentBanner() {
  return (
    <div
      ...
      style={{
        height: 152,
        background: "linear-gradient(to bottom, #A456F6, #2F2546)",
    ...
    >
      ...
      >
        <div className="flex flex-1 flex-col justify-center min-h-px min-w-px">
          <p className="font-bold text-[16px] text-primary-600 leading-[18px] text-left">Tournament Rules</p>
        </div>
        <motion.div
          className="shrink-0"
        ...
        {open && (
          ...
          >
            ...
            <div className="text-[14px] text-primary-600 leading-[20px] w-full">
              <p className="mb-5">
                For the adventurers who love a good fright-night, we have the perfect tournament in store! Our Undead Tournament will take you on a spooky quest which will make even the most hardened explorers quake in their boots. Players must wager at least 50p on any of the slots above to be automatically take part in this tournament. The tournament runs on &laquo;max winnings rate&raquo; and &laquo;win streak&raquo; formulas. A &laquo;Max winnings rate&raquo; formula means that a player gets 0 points for each x0 to x1 win, 1 point for each x1 to x3 win, 5 points for each x3 to x7 win, 20 points for each x7 to x15 win, 75 points for each x15 to x30 win, 150 points for each x30 to x75 win, 300 points for each x75 to x100 win, and 999 points for winning more than x100. A &laquo;Win streak&raquo; formula means that a player gets 1 point for 1 win, 3 points for 2 consecutive wins, 7 points for 3 consecutive wins, 15 points for 4 consecutive wins, 50 points for 5 consecutive wins, and 150 points for 6 or more consecutive wins.
              </p>
              <p className="mb-5">
                The maximum number of winnings within a streak is taken into account when points are calculated. Points received for &laquo;max winnings rate&raquo; and &laquo;win streak&raquo; are calculated and automatically added to your total. The Booster option is enabled in this tournament. Booster is a feature which allows a player to collect more points throughout the tournament. Booster is enabled automatically on a player&apos;s account when the player one place higher in the leaderboard becomes &ldquo;not active&rdquo;. A player is assumed to be &ldquo;not active&rdquo; if more than 15 minutes have passed since their last bet was made on any of the active tournament games. In such cases a player who is directly below them in the leaderboard receives a booster which allows them to earn 50% more points until either they have surpassed the &ldquo;not active&rdquo; player on the leaderboard or the &ldquo;not active&rdquo; player becomes active.
              </p>
              <p>
                <span>See </span>
...
function LeaderboardSection() {
  ...
  return (
    <div className="flex flex-col gap-4 items-start w-full">
      <p className="font-bold text-[16px] text-primary-600 leading-[18px] w-full">Leaderboard</p>

      {/* Tabs */}
      <div className="overflow-x-auto scrollbar-hide w-full">
        <div className="flex items-center p-1 rounded-[20px] w-max" style={{ backgroundColor: "#363555" }}>
          {LEADERBOARD_TABS.map((tab, i) => (
            <button
              key={tab}
              onClick={() => setActiveTab(i)}
              className={`flex h-8 items-center justify-center px-4 rounded-[20px] shrink-0 ${
                i === activeTab ? "text-white" : ""
              }`}
              style={i === activeTab ? { backgroundColor: "#8352FF" } : undefined}
            >
              <span
                className="font-bold text-lg leading-[16px] text-center whitespace-nowrap"
                style={{ color: i === activeTab ? "#FFFFFF" : "#B5B5C5" }}
              >
                {tab}
              </span>
            </button>
...
function TournamentGamesSection() {
  return (
    <div className="flex flex-col gap-4 items-start w-full">
      <div className="flex items-center justify-between w-full">
        <p className="flex-1 font-bold text-[16px] text-primary-600 leading-[18px]">Tournament Games</p>
    ...
    <>
      ...
      <main className="flex-1 overflow-y-auto" style={{ backgroundColor: "#1F1E2E" }}>
        <div className="flex flex-col gap-6 items-start justify-center p-4 w-full">
          {/* Banner + Info block (gap-4) */}
          <div className="flex flex-col gap-4 items-start w-full">
            <TournamentBanner />
            <ParticipatingPill />
            <PrizeTimerBlock />
            <ConditionsBlock items={CONDITIONS_1} />
            <ConditionsBlock items={CONDITIONS_2} />
          </div>
